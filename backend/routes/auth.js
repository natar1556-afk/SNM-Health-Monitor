...
const sendVerificationEmail = async (user) => {
  ...
  const text = `Hi ${user.name || "there"},\n\nFinish setting up your SNM Health Monitor account by verifying your email: ${verifyUrl}\n\nThis link expires in 24 hours.`;
  const html = `<p>Hi ${user.name || "there"},</p><p>Finish setting up your SNM Health Monitor account by verifying your email.</p><p><a href="${verifyUrl}" target="_blank" rel="noreferrer">Verify my email</a></p><p>This link expires in 24 hours.</p>`;
